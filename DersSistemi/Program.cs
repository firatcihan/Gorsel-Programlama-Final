...
class Program
{
    ...
    static void ornekVerileriEkle()
    {
        ...
        {
            ogrenciler.Add(new Ogrenci { Isim = "firat", OgrenciNo = "1" });
            ogrenciler.Add(new Ogrenci { Isim = "ibrahim", OgrenciNo = "2" });

            ogretimGorevlileri.Add(new OgretimGorevlisi { Isim = "Erkan Aydın", Bolum = "Bilgisayar Programcılığı" });
            ogretimGorevlileri.Add(new OgretimGorevlisi { Isim = "Refik Tanju Sirmen", Bolum = "Bilgisayar Programcılığı" });

            var ders1 = new Ders { DersAdi = "İnternet Programcılığı", Kredi = 3, OgretimGorevlisi = ogretimGorevlileri[0] };
            var ders2 = new Ders { DersAdi = "İşletim Sistemleri", Kredi = 4, OgretimGorevlisi = ogretimGorevlileri[1] };
